...
RECT S11_rs[] = { XPOS(-99), YPOS(-99), RXPOS(-99) + 1, BYPOS(-99) + 1 };
RECT S12_rs[] = { XPOS(-99), YPOS(-99), RXPOS(-99) + 1, BYPOS(-99) + 1 };
RECT S13_rs[] = {
    ...
    {XPOS(5), YPOS(14), RXPOS(6) + 1, BYPOS(15) + 1 },
    ...
    {XPOS(11), YPOS(14), RXPOS(12) + 1, BYPOS(15) + 1 },
